        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          <div>
            ...
            <div className="flex gap-4">
              <a href="#" className="w-10 h-10 rounded-full glass flex items-center justify-center hover:neon-border transition-all">
          ...
          <div>
            ...
            <ul className="space-y-3">
              <li>
                <a href="#" className="text-gray-300 hover:text-neon-blue transition-colors">Web Development</a>
              </li>
              <li>
                <a href="#" className="text-gray-300 hover:text-neon-blue transition-colors">SEO Optimization</a>
              </li>
              <li>
                <a href="#" className="text-gray-300 hover:text-neon-blue transition-colors">UI/UX Design</a>
              </li>
              <li>
                <a href="#" className="text-gray-300 hover:text-neon-blue transition-colors">Digital Marketing</a>
              </li>
              <li>
                <a href="#" className="text-gray-300 hover:text-neon-blue transition-colors">Web Maintenance</a>
              </li>
              <li>
                <a href="#" className="text-gray-300 hover:text-neon-blue transition-colors">E-commerce Solutions</a>
              </li>
            </ul>
          </div>
